    ...
    <div class="app-container">
      ...
      <page-tools :show-before="true">
        ...
        <template v-slot:after>
          ...
          <el-button disabled size="mini" type="primary" @click="$router.push(`/salary/monthStatement?yearMonth=${yearMonth}`)">{{ yearMonth }}报表</el-button>
        </template>
      </page-tools>
      <!-- 条件筛选 -->
      ...
      <el-card class="hr-block">
        <el-table :data="list" style="width: 100%">
          ...
          <el-table-column label="津贴方案" width="120">通用方案</el-table-column>
          ...
          <el-table-column label="操作" width="240">
            <template slot-scope="scope">
              ...
              >定薪</el-button>
              <el-button type="text" size="mini" @click="$router.push(`/salary/details/'+yearMonth+'/'+scope.row.id`)">
                <!--   <router-link :to="{'path': '/salary/details/'+yearMonth+'/'+scope.row.id}">查看</router-link> -->查看
              </el-button>
            </template>
          </el-table-column>
        </el-table>
