    ...
    <div class="app-container">
      ...
      <page-tools :show-before="true">
        ...
        <template v-slot:after>
          <el-button size="mini" type="danger" disabled>导入</el-button>
          <el-button size="mini" type="warning">提醒</el-button>
          <el-button size="mini" type="primary" @click="handleSet">设置</el-button>
          <el-button size="mini" type="default" @click="$router.push('/attendance/archiving/')">历史归档</el-button>
          <el-button size="mini" type="primary" @click="$router.push({'path':'/attendance/report/'+ yearMonth})">{{ yearMonth }}报表</el-button>
        </template>
      </page-tools>
