...
export default {
  ...
  data() {
    return {
      userInfo: {
        ...
        timeOfEntry: '', // 入职时间
        correctionTime: '', // 转正时间
        staffPhoto: 'http://pic.imeitou.com/uploads/allimg/220615/6-220615160Z1.jpg'
      },
      rules: {
  ...
  created() {
    // 如何获取路由参数中的id
    // console.log(this.$route.params.id) 可以拿到详情的id
