    ...
    <div class="app-container">
      ...
      <page-tools :show-before="true">
        ...
        <template v-slot:after>
          <el-button size="mini" type="primary" @click="$router.push('/approval/securitySetting')">流程设置</el-button>
        </template>
      </page-tools>
      <!-- <ApprovalPageTool /> -->
...
export default {
  ...
  methods: {
    ...
    toDetail(obj) {
      ...
      switch (name) {
        case '工资':
          this.$router.push({ path: '/approval/salaryApproval/' + obj.processId })
          break
        case '入职':
          this.$router.push({ path: '/approval/enterApproval/' + obj.processId })
          break
        case '请假':
          this.$router.push({ path: '/approval/leaveApproval/' + obj.processId })
          break
        case '离职':
          this.$router.push({ path: '/approval/quitApproval/' + obj.processId })
          break
        case '加班':
          this.$router.push({ path: '/approval/overtimeApproval/' + obj.processId })
      }
    },
